...
//-------------------------------inicio do jogo---------------------------------
     ...
     * <p>
     * - Invoca o metodo do {@link tabuleiro#iniciapecas()}</p>
     */
     ...
     * <p>
     * - Invoca o metodo do
     * {@link tabuleiro#iniciapecastesteFinal()}</p>
     */
     ...
     * Muda phase para 1</p>
     * <p>
     * invoca {@link FXMLDocumentController#imprime()}</p>
     * <p>
     * invoca {@link FXMLDocumentController#imprimeronda()}</p>
     * <p>
     * invoca {@link FXMLDocumentController#imprimebotao()}</p>
     */
     ...
     * <p>
     * Se phase == 2 invoca
     * {@link FXMLDocumentController#click1()}</p>
     * <p>
     * Se phase == 3 invoca
     * {@link FXMLDocumentController#click2()}</p>
     *
     ...
     * final invoca {@link FXMLDocumentController#imprimedados()}
     */
     ...
     * {@link FXMLDocumentController#imprimedados()} Invoca
     * {@link FXMLDocumentController#imprimedados()}
     *
     */
    public void imprime() {
        imprimeretangulos();
     ...
     * <p>
     * No final invoca
     * {@link FXMLDocumentController#imprimeretangulosjog} com os
     * atributos do jogador</p>
     * <p>
     * E invoca {@link FXMLDocumentController#imprimeretangulosjog}
...
//necessario repetir "for" para garantir que as peças estejam no topo da hierarquia
     ...
     * <p>
     * No final invoca
     * {@link FXMLDocumentController#imprimepecasjog} com os
     * atributos do jogador</p>
     * <p>
     * E invoca {@link FXMLDocumentController#imprimepecasjog}
     * novamente com os atributos do adversario</p>
     *
     */
    @FXML
     ...
     * {@link dado#rodadado} para dado 1 invoca
     * {@link dado#rodadado} para dado 2
     */
     ...
     * {@link FXMLDocumentController#clickfimjogo()} caso a posição
     * final seja outra invoca
     * {@link FXMLDocumentController#clicknormal()}
     */
    public void click2() {
     ...
     * {@link FXMLDocumentController#condicaovitoria}
     */
...
//função para usar o menor dos dois dados
     ...
     * {@link Server#receberpecas} invoca
     * {@link Server#receberJog()} para jogador 1 invoca
     * {@link Server#receberJog()} para jogador 2
     */
     ...
     * {@link casa#addpecabranca()} ou
     * {@link casa#addpecapreta()} para inserir a peça no centro e
     * em seguida invoca {@link casa#rempeca()} para remover a peça
     */
    public void comivel() {
