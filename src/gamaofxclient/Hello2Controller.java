...
public class Hello2Controller implements Initializable{
     ...
     * Muda phase para 1</p>
     * <p>
     * invoca {@link Hello2Controller#imprime()}</p>
     * <p>
     * invoca {@link Hello2Controller#imprimeronda()}</p>
     * <p>
     * invoca {@link Hello2Controller#imprimebotao()}</p>
     */
     ...
     * <p>
     * Se phase == 2 invoca
     * {@link Hello2Controller#click1()}</p>
     * <p>
     * Se phase == 3 invoca
     * {@link Hello2Controller#click2()}</p>
     ...
     * no final invoca {@link Hello2Controller#imprimedados()}
     */
     ...
     *Invoca {@link Hello2Controller#imprimedados()}
     *Invoca {@link Hello2Controller#imprimedados()}
     *
     */
    public void imprime() {
     ...
     * <p>
     * No final invoca
     * {@link Hello2Controller#imprimeretangulosjog} com os
     * atributos do jogador</p>
     * <p>
     * E invoca
     * {@link Hello2Controller#imprimeretangulosjog}
...
//necessario repetir "for" para garantir que as peças estejam no topo da hierarquia
     ...
     * <p>
     * No final invoca
     * {@link Hello2Controller#imprimepecasjog} com os
     * atributos do jogador</p>
     * <p>
     * E invoca
     * {@link Hello2Controller#imprimepecasjog}
     * novamente com os atributos do adversario</p>
     *
     */
    @FXML
     ...
     * caso a posição final seja uma casa de um jogador invoca {@link Hello2Controller#clickfimjogo()}
     * caso a posição final seja outra invoca {@link Hello2Controller#clicknormal()}
     */
    public void click2() {
     ...
     * no final invoca {@link Hello2Controller#condicaovitoria}
     */
...
//função para usar o menor dos dois dados
    ...
    public void guardascore(MouseEvent event) {
        ...
        try {
            ...
            Logger.getLogger(Hello2Controller.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
